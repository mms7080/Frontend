      ...
      <Box maxW="1100px" mx="auto" pt={12} px={{ base: 4, md: 6 }} pb={20}>
        ...
        <Flex direction={{ base: 'column', md: 'row' }} gap={10} align="flex-start">
          ...
          <Box flex="1">
            ...
            <Flex direction={{ base: "column", sm: "row" }} align="center" gap={4} mb={4}>
              <Text fontWeight="bold" fontSize="md">수량선택</Text>
              <select
                value={quantity}
            ...
            <Flex
              ...
              wrap="wrap"
            >
              <Button variant="outline" w={{ base: "100%", sm: "100px" }} borderColor="gray.300">
                🎁 선물
              </Button>

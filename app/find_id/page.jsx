...
export default function Find_id(){
    ...
    const handleFindID=async ()=>{
        ...
        else if(formData.method==='method')setFormData(f=>({...f,phone_number:document.querySelector('#phone_number').value}));
    ...
    const PhoneLayout=()=>{
        return <>
                ...
                <Input id="phone_number" name="phone_number" placeholder="01012345678" required/>
            </>;
    }
